...
Now that we have cleaned the data set, we can begin exploring it. We will start this process by looking individually at the different variables - determining the main components that make up each variable in the cleaned data set, as well as what proportion they represent...

```{r}
# We begin by counting 
prop_age <- ask_a_manager_2021 %>% 
